...
const forumTradeController = {

  getForumTrade: function(req, res) {
    ...
    db.findOne(User, query, projection, function(result) {
      if (result != null) {
        ...
        ForumTrade.find({},).exec((err, result) => {
          if (err) {
        ...
        if (result.dislikedPosts.includes(postID)) {
          ...
          db.findOne(ForumTrade, {postID: postID}, '', function(result) {
            if (result != null) {
              ...
              db.updateOne(ForumTrade, {postID: postID}, { $set: {rating: newRating} }, function (flag) {
                if (flag) {
...
module.exports = forumTradeController;
